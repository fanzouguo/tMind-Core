...
function testMoveUp(arr: IObj<any>[], fromIdx: number,  destIdx: number, itemCount: number, orderField: string): void {
...
function testMoveDown(arr: IObj<any>[], fromIdx: number,  destIdx: number, itemCount: number, orderField: string): void {
 ...
 */
function arrMoveItem(arr: IObj<any>[], fromIdx: number,  destIdx: number, itemCount: number, orderField: string): void {
	const _tp = checkType(arr[0]);
	if (_tp === ETYPE.object) {
		if (fromIdx > destIdx) {
